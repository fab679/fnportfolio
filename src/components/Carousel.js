...
class Carousel extends React.Component {
    ...
    render() {
        return(
            ...
            <h2>Portfolio</h2>
            <h6>Currently, i have no complete projects but as i finish some i will be posting the here. Hire me let me showcase your site here.</h6>
                <Row className="justify-content-around" expand="lg">
